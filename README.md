...
├── requirements.txt
├── README.md
├── architecture_diagram_cleaner.md
...
For deployment proof, see the Devpost submission or the repository materials showing Vertex AI usage and Google Cloud-backed execution.
...
Recommended exported assets for judges:
- a rendered PNG version of the architecture diagram,
- a short deployment-proof recording,
- screenshots of the published issue.
...
If you are evaluating the project, a good test run is:
...
- [x] Spin-up instructions in README
- [x] Architecture diagram
- [x] Google Cloud / Vertex AI usage in code
- [x] HTML / PDF / Markdown outputs
- [ ] Demo video
- [ ] Deployment proof recording or deployment screenshot
